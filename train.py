...
tf.flags.DEFINE_string("domain_model_version", "domain", "domain model version")
...
def preprocess():
    ...
    # Build vocabulary
    domain_train_dir = './runs_base/' + FLAGS.domain_model_version
    domain_train_params_dir = domain_train_dir + '/trained_results/train_params.json'
    domain_train_params = json.loads(open(domain_train_params_dir).read())
    max_document_length = domain_train_params['max_document_length']#this parameter must be the same as train_domain.py
    domain_vocab_path = domain_train_dir + '/vocab'
    vocab_processor = learn.preprocessing.VocabularyProcessor.restore(domain_vocab_path)
    ...
    return x_train, y_train, vocab_processor, x_dev, y_dev, x_real_len_train, x_real_len_dev, sorted_label, max_document_length
...
def main(argv=None):
    x_train, y_train, vocab_processor, x_dev, y_dev, x_real_len_train, x_real_len_dev, sorted_label, max_document_length = preprocess()
    train(x_train, y_train, vocab_processor, x_dev, y_dev, x_real_len_train, x_real_len_dev, sorted_label, max_document_length)
