...
import datetime
import data_helpers
from text_cnn_domain import TextCNN
...
tf.flags.DEFINE_string("domain_train_data_file", "./data/domain_cnews.train.seg", "train data for Chinese.")
...
def preprocess():
    ...
    # Load data
    print("Loading data...")
    x_text, y, sorted_label = data_helpers.load_data(FLAGS.domain_train_data_file)
...
def train(x_train, y_train, vocab_processor, x_dev, y_dev, x_real_len_train, x_real_len_dev, sorted_label):
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            out_dir = os.path.abspath(os.path.join(os.path.curdir, "runs_base", FLAGS.model_version))
            print("Writing to {}\n".format(out_dir))
